                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><?= ++$i; ?></td>
                                                <td><?= $pegawai->nama ?></td>
                                                <td><?= $this->Domisili_m->get_row(['id_pegawai' => $pegawai->id_pegawai])->nilai ?> KM</td>
                                                <td><?= $this->Tes_tertulis_m->get_row(['id_pegawai' => $pegawai->id_pegawai])->nilai ?></td>
                                                <?php
        ...
        <?= form_open('penilai/penilaian'); ?>
          ...
          <div class="modal-body">
            <div class="form-group label-floating">
                ...
                <select name="id_pegawai" class="form-control" id="select" style="width: 100%;" >
