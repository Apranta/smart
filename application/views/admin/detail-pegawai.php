                                ...
                                <div class="panel-body">
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                <?php foreach ($this->Nilai_tes_m->get() as $value): ?>
                                                    <td><?= ($this->Tes_tertulis_m->get_row(['id_id_pegawai' => $data->id_pegawai , 'id_nilai' => $value->id_nilai])) ? $this->Tes_tertulis_m->get_row(['id_id_pegawai' => $data->id_pegawai , 'id_nilai' => $value->id_nilai])->nilai : 0 ?> </td>
                                                <?php endforeach ?>
                                            </tr>
                                        </tbody>
                                    </table>                
