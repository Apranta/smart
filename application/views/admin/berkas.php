                        ...
                        <table class="table table-bordered table-responsive">
                            ...
                            <tbody>
                                ...
                                foreach ($data as $Pegawai) :
                                    $berkas = $this->Data_berkas_m->get(['id_pegawai' => $Pegawai->id_pegawai]);
                                ?>
                                    <tr>
                                        <td><?= ++$i  ?></td>
                                        <td><?= $Pegawai->nama ?></td>
                                            ...
                                            <?php else : ?>
                                                <ul>
                                                    <?php foreach ($berkas as $key) : ?>
                                                        <li><button onclick="view(<?= $key->id ?>)" data-toggle="modal" data-target="#view" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i>&nbsp; <?= $this->Berkas_m->get_row(['id_berkas' => $key->id_data_berkas])->nama ?></button></li>
                                                    <?php endforeach ?>
                                                </ul>
                                            <?php endif ?>
                                        </td>
